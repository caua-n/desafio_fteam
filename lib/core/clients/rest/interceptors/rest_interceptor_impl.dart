...
import '../constants/dio_adapter.dart';

class RestInterceptorImpl implements Interceptor {
  final IRestInterceptor interceptor;

  RestInterceptorImpl({required this.interceptor});
